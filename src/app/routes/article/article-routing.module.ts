...
const routes: Routes = [{ path: 'create', component: ArticleCreateComponent }, { path: 'list', component: ArticleListComponent }, { path: 'tags', component: ArticleTagsComponent }, { path: 'category', component: ArticleCategoryComponent }];
